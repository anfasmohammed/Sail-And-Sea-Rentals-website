...
const Home = () => {
  return (
    ...
    <div className='flex flex-col w-full gap-3 justify-center items-center text-orange-200 bg-red-200 opacity-20 '>
    <h1 className='text-2xl lg:text-5xl fond-bold'>HELLO RIDERS </h1>
    <h2 className='text-base lg:text-2xl font-semibold'>Welcome to the world of boating,feast your eyes to the vast sea.</h2>
    </div>
