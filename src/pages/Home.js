...
const Home = () => {
  return (
    <div>
    <div className='flex items-center flex-col gap-6 justify-center w-full h-[70vh] bg-no-repeat bg-center bg-cover bg-[url(https://images.pexels.com/photos/13856740/pexels-photo-13856740.jpeg)] '> 
